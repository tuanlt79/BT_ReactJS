...
export default class RenderMapBT extends Component {
  dataFilm = [
    {
      maPhim: 1321,
      tenPhim: "Ted2",
  ...
  renderFilm = () => {
    const arrPhim = this.dataFilm.map((phim, index) => {
      return (
            ...
            <div className="card-body">
              <h4 className="card-title" style={{ height: 50 }}>
                {phim.tenPhim.length > 50 ? (
                  <p>{phim.tenPhim.substr(0, 100)}...</p>
                ) : (
                  <p>{phim.tenPhim}</p>
                )}
              </h4>
              <div className="card-text" style={{height:80}}>
